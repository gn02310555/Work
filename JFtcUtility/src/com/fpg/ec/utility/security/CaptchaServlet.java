...
public class CaptchaServlet extends HttpServlet implements Servlet {
    ...
    public final static int DigitalNum = 5;
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getSession().setAttribute(CaptchaServlet.SIMPLE_CAPCHA_SESSION_KEY, test);
        //req.setAttribute(FpgCaptchaServlet.SIMPLE_CAPCHA_SESSION_KEY, test);
        ...
        graphics.setBackground(Color.white);//gray
        ...
        TextLayout textTl = new TextLayout(test, new Font("Courier", Font.BOLD, 70), new FontRenderContext(null, true, false));
        ...
        this.drawThickLine(graphics, 0, generator.nextInt(ImageHeight) + 1, ImageWidth, generator.nextInt(ImageHeight) + 1, 4, Color.pink);
        //this.drawThickLine(graphics,0,1,ImageWidth,1,	4,Color.red);
